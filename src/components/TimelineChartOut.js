...
export default class TimelineChartOut extends Component {
  ...
  componentDidMount  = () => {
    fetch('/api/public/card/7f808a79-89e9-4730-b70a-882e99657958/query?parameters=%5B%7B"type"%3A"category"%2C"target"%3A%5B"variable"%2C%5B"template-tag"%2C"rcv_hub_id"%5D%5D%2C"value"%3A%22' + this.state.hub_id + '%22%7D%5D')
